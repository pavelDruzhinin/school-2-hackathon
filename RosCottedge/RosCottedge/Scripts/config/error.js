    ...
    $('#validCreateHouse').validate({
        ...
        messages: {
            ...
            Description: {
                ...
                minlength: "Минимальная длина описания дома, 3 символа"
            },
            briefDescription: {
            ...
            Food: {
                ...
                minlength: "Минимальная длина описания предоставляемого питания, 3 символа"
            },
            Transfer: {
                required: "Введите описание предоставляемого трансфера",
                minlength: "Минимальная длина описания предоставляемого трансфера, 3 символа"
            },
            ServicesIncluded: {
                required: "Введите услуги, включенные в стоимость",
                minlength: "Минимальная длина услуг, включенных в стоимость, 3 символа"
            },
            AdditionalServices: {
                required: "Введите услуги за отдельную плату",
                minlength: "Минимальная длина услуг за отдельную плату, 3 символа"
            },
            Accomodations: {
                required: "Введите условия проживания",
                minlength: "Минимальная длина условий проживания, 3 символа"
            },
            BookingConditions: {
                required: "Введите условия бронирования",
                minlength: "Минимальная длина условий бронирования, 3 символа"
            }
        },
        focusCleanup: true,
        focusInvalid: false,
